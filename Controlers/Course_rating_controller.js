...
if(data.user){
    ...
    if(exist_rating){
        ...
        const rating = course_rating_model({
        ...
        return new Promise(
            async (resolve, reject) => {
                ...
                try {
                    ...
                    if(id){
                        const rating= await course_rating_model.find({course_id:id}).populate("course_id")
resolve(
    { msg: " rating finded ", status: 1 , rating}
                     ...
                     const rating= await course_rating_model.find().populate("course_id")
